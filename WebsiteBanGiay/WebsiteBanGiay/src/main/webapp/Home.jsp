...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"> 
      ...
      .carousel-item:nth-child(1) {
        background-image: url('https://intphcm.com/data/upload/poster-giay-dep-mat.jpg');
      ...
      .carousel-item:nth-child(2) {
        background-image: url('https://lambanner.com/wp-content/uploads/2022/10/MNT-DESIGN-BANNER-GIAY-11.jpg');
        background-repeat: no-repeat;
        background-size: 100% 100%;
        background-position: center center;
      }
      ...
      .carousel-item:nth-child(3) {
        background-image: url('https://lambanner.com/wp-content/uploads/2022/10/MNT-DESIGN-BANNER-GIAY-03.jpg');
        background-repeat: no-repeat;
        background-size: 100% 100%;
        background-position: center center;
      }
 ...
 <!-- Carousel wrapper -->
  ...
  <div class="card" style="border-style: none;">
    <img style="height:55px; width:64px; margin: auto;" src="https://file.hstatic.net/1000191021/file/4-icon-shipper_9937d5a87ccd40c686194426bf740106_grande.png">
    <div class="card-body">
  ...
  <div class="card" style="border-style: none;">
    <img class="card-img-top" style="height:55px; width:64px; margin: auto;" src="https://cdn.haitrieu.com/wp-content/uploads/2022/10/Icon-VNPAY-QR.png" alt="Card image cap">
    <div class="card-body">
  ...
  <div class="card" style="border-style: none;">
    <img class="card-img-top" style="height:55px; width:64px; margin: auto;" src="https://png.pngtree.com/png-clipart/20210312/original/pngtree-warranty-line-on-icon-13-png-image_6075117.png" alt="Card image cap">
    <div class="card-body">
  ...
  <div class="card" style="border-style: none;">
    <img class="card-img-top" style="height:55px; width:64px; margin: auto;" src="https://png.pngtree.com/png-clipart/20231220/original/pngtree-money-exchange-icon-change-photo-png-image_13884903.png" alt="Card image cap">
    <div class="card-body">
                        ...
                        <div id="content" class="row">
                            <div class=" col-12 col-md-12 col-lg-6">
                                    <div class="card-body">
                                        ...
                                        <h2 class="card-title show_txt" style="text-align:center; font-size:24pt;">Top Shop</h2>
										...
										Hãy đến với Top Shop – nơi bạn thỏa lòng mong ước mà chỉ phải chi ra 1 phần nhỏ so với dòng chính hãng ngoài store 
										mà vẫn sắm cho mình được một đôi chất lượng từ rep 1:1 đến siêu cấp like auth.</p>                  
                                    </div>  
                            </div>
                            <div class=" col-12 col-md-12 col-lg-6">
                                    <img class="card-img-top" src="https://img.pikbest.com/png-images/20240425/spirited-mothers-day-holiday-wishes-222024-png-images-png_10533223.png!w700wp" alt="Card image cap">        
                            </div>
                    </div>
                </div>
            </div>
